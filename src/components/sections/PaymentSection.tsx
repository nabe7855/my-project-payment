 ...
 * Stripeへの決済ボタンを配置しています。
 * 
 * @returns {JSX.Element} 決済セクションのUI
 */
const PaymentSection: React.FC = () => {
    const handlePayment = () => {
        // Stripe Checkoutへのリダイレクト処理は将来的にここに追加します。
        alert('Stripeの決済ページへリダイレクトします。(デモ)');
    };
            ...
            <div className="max-w-3xl mx-auto px-4 text-center">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border-2 border-[#80b963]">
                    ...
                    <p className="text-xs text-gray-400 mt-4">
                        上のボタンを押すと、Stripeの安全な決済ページに移動します。（現在はデモです）
                    </p>
                </div>
            </div>
        </section>
